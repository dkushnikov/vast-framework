...
- [`applications.md`](./applications.md) — cross-domain instantiations (KosmOS, company transformation) and worked VAST examples per function (CX, Marketing, People, Finance, Operations). Shows what Vision, Architecture (capability framework), Strategy, and Tactics look like in each domain.
...
- [`case-studies/`](./case-studies/) — applied examples. Each follows the same structure: context, layers, challenge flow in action, what VAST prevented, artifacts, lessons.
  ...
  - [`case-studies/002-distributed-atlas.md`](./case-studies/002-distributed-atlas.md) — Distributed AI partner system (meta-application)
  - [`case-studies/003-slack-logic.md`](./case-studies/003-slack-logic.md) — Slack business-logic layer on agentic transport (in progress)
